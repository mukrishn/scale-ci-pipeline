...
def stage_two = env.STAGE_TWO.toString().toUpperCase() ? "FALSE" : "FALSE"
def stage_three = env.STAGE_THREE.toString().toUpperCase() ? "FALSE" : "FALSE"
def stage_four = env.STAGE_FOUR.toString().toUpperCase() ? "FALSE" : "FALSE"
def stage_five = env.STAGE_FIVE.toString().toUpperCase() ? "FALSE" : "FALSE"
def stage_six = env.STAGE_SIX.toString().toUpperCase() ? "FALSE" : "FALSE"
def webfuse_install = env.WEBFUSE_INSTALL.toString().toUpperCase() ? "FALSE" : "FALSE"
