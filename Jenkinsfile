...
def stage_two = env.findProperty('STAGE_TWO') ?: "FALSE"
def stage_three = env.findProperty('STAGE_THREE') ?: "FALSE"
def stage_four = env.findProperty('STAGE_FOUR') ?: "FALSE"
def stage_five = env.findProperty('STAGE_FIVE') ?: "FALSE"
def stage_six = env.findProperty('STAGE_SIX') ?: "FALSE"
def webfuse_install = env.findProperty('WEBFUSE_INSTALL') ?: "FALSE"
