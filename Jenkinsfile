...
def stage_two = STAGE_TWO.toString().toUpperCase() ? STAGE_TWO : "FALSE"
def stage_three = STAGE_THREE.toString().toUpperCase() ? STAGE_THREE : "FALSE"
def stage_four = STAGE_FOUR.toString().toUpperCase() ? STAGE_FOUR : "FALSE"
def stage_five = STAGE_FIVE.toString().toUpperCase() ? STAGE_FIVE : "FALSE"
def stage_six = STAGE_SIX.toString().toUpperCase() ? STAGE_SIX : "FALSE"
def webfuse_install = WEBFUSE_INSTALL.toString().toUpperCase() ? WEBFUSE_INSTALL : "FALSE"
