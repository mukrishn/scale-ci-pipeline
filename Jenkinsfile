...
def stage_two = STAGE_TWO.toString().toUpperCase() ? "FALSE" : "FALSE"
def stage_three = STAGE_THREE.toString().toUpperCase() ? "FALSE" : "FALSE"
def stage_four = STAGE_FOUR.toString().toUpperCase() ? "FALSE" : "FALSE"
def stage_five = STAGE_FIVE.toString().toUpperCase() ? "FALSE" : "FALSE"
def stage_six = STAGE_SIX.toString().toUpperCase() ? "FALSE" : "FALSE"
def webfuse_install = WEBFUSE_INSTALL.toString().toUpperCase() ? "FALSE" : "FALSE"
